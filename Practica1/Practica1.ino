 ...
 *************************************************************/
// Definición de pines
const int led_verde_autos = 14;
const int led_ambar_autos = 13;
const int led_rojo_autos = 11;
...
const int tiempo_minimo_verde_auto = 6000;
...
void semaforo_init(void) {
   ...
   digitalWrite(led_ambar_autos, LOW);
...
void semaforo_autos_rojo(void) {
   ...
   for(int i=4; i>0; i--) {
      delay(500);
      digitalWrite(led_ambar_autos, HIGH);
      delay(500);
      digitalWrite(led_ambar_autos, LOW);
   }
...
void setup() {
   ...
   pinMode(led_ambar_autos, OUTPUT);
